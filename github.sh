...
map["Git-Automation"] = "Git-Automation-1"  # replace remote with remote you created and replace original with your repository you want to push the files
...
for i in "${!map[@]}"
do
    git remote add $i https://github.com/The-Lord-Buddha-Club/${map[$i]}.git # replace "The-Lord-Buddha-Club" with your Github username
